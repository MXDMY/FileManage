...
struct qt_meta_stringdata_FMListView_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FMListView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FMListView_t qt_meta_stringdata_FMListView = {
    {
QT_MOC_LITERAL(0, 0, 10) // "FMListView"
...
const QMetaObject FMListView::staticMetaObject = {
    { &QListView::staticMetaObject, qt_meta_stringdata_FMListView.data,
      qt_meta_data_FMListView,  qt_static_metacall, nullptr, nullptr}
};
...
void *FMListView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FMListView.stringdata0))
