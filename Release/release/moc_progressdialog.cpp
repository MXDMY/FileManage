...
QT_MOC_LITERAL(1, 15, 17), // "interruptReceived"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 21) // "on_toolButton_clicked"

    },
    "ProgressDialog\0interruptReceived\0\0"
...
void ProgressDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->interruptReceived(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProgressDialog::interruptReceived)) {
                *result = 0;
                return;
            }
        }
